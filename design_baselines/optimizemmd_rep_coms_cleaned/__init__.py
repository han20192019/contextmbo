...
from design_baselines.optimizemmd_rep_coms_cleaned.trainers import ConservativeObjectiveModel
from design_baselines.optimizemmd_rep_coms_cleaned.nets import ForwardModel
from design_baselines.optimizemmd_rep_coms_cleaned.nets import RepModel
...
def coms_cleaned(
    ...
    trainer = ConservativeObjectiveModel(mmd_param = mmd_param, 
        ...
        entropy_coefficient=particle_entropy_coefficient, x_ori=initial_x)
    ...
    for step in range(0, 1 + particle_evaluate_gradient_steps):
        ...
        if not fast or step == particle_evaluate_gradient_steps:
            ...
            mmd = tf.reduce_sum(tf.square(group_logged_rep-xt_rep))
