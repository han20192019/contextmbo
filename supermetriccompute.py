...
experiment = tb.data.experimental.ExperimentFromDev(conductor_experiment_id)
...
sns.pointplot(x = mmd_list, y = alist).set_title("super prediction value")
plt.savefig("superpredictionvalue.jpg")

plt.figure(figsize=(16, 6))
sns.pointplot(x = mmd_list, y = blist).set_title("super prediction error")
plt.savefig("superpredictionerror.jpg")

plt.figure(figsize=(16, 6))
sns.pointplot(x = mmd_list, y = clist).set_title("super mmd loss")
plt.savefig("supermmdloss.jpg")
