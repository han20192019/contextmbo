...
seed = [1,2,3,4,5]
mmd_param = [10000] #[0.1, 0, 10, 500, 2000, 5000, 10000]
...
for d in d_list:
    for s in seed:
        for m in mmd_param:
            coms_cleaned(logging_dir = "/nfs/kun2/users/hanqi2019/1223super/seed"+str(s)+"/"+name+"rep"+str(d)+"seed"+str(s)+"mmd"+str(m),
                                    task=task,
                                    task_relabel=True,
                                    normalize_ys=True,
                                    normalize_xs=True,
