...
seed = [1]
mmd_param = [100, 500, 1000] #[0.1, 0, 10, 100, 500, 1000]
dim = 32 #16,32,64,128,256
for s in seed:
    for m in mmd_param:
        coms_cleaned(logging_dir = "/nfs/kun2/users/hanqi2019/1207discrete/tf8/tfrep"+str(dim)+"seed"+str(s)+"mmd"+str(m),
