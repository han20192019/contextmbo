...
experiment = tb.data.experimental.ExperimentFromDev(kitty_experiment_id)
...
sns.pointplot(x = mmd_list, y = alist).set_title("kitty prediction value")
plt.savefig("kittypredictionvalue.jpg")

plt.figure(figsize=(16, 6))
sns.pointplot(x = mmd_list, y = blist).set_title("kitty prediction error")
plt.savefig("kittypredictionerror.jpg")

plt.figure(figsize=(16, 6))
sns.pointplot(x = mmd_list, y = clist).set_title("kitty mmd loss")
plt.savefig("kittymmdloss.jpg")
